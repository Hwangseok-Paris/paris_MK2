...
const skills: Skill[] = [
  ...
  { name: "Next", color: "bg-black", iconPath: "/icons/nextdotjs_dark.svg" },
...
export default function SkillSet() {
  ...
  const skillMode = useMemo(() => {
    return skills.map((s) => {
      if (s.name === "Next") {
        s.iconPath = mode === "dark" ? "/icons/nextdotjs_dark.svg" : "/icons/nextdotjs_light.svg";
      }
      return s;
    });
  }, [mode]);
